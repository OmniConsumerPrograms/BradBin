...
// OCP Dungeon Manager (Vu's GameManager)
...
public class DungeonTester
{
	...
	private static ArrayList<IFloor> mazeList = new ArrayList<IFloor>();
	...
	public static void startGame() throws Exception
	{
		...
		String choice = DungeonMenu.printFirstMenu();
	...
	private static void resumeGame() throws Exception
	{
		...
		for(int k = (curFloorNo-1) ; k< mazeList.size(); k++)
		{
			...
			while(canMove)
			{
				...
				move(choice);
				if(floor[curPos.getRow()][curPos.getCol()] == 'O')
				{
					break;
					
				}
				else if (floor[curPos.getRow()][curPos.getCol()] == 0 || floor[curPos.getRow()][curPos.getCol()] == '#')
				{
					curPos = temp;
	...
	*/
	...
	private static void runGame(int curFloorNo )
	{
		...
		//System.out.println(FloorManager.printFloor(curFloor.getFloor()));
